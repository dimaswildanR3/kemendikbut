...
<div class="container">
    <div class="card">
        <h5 class="card-header d-flex justify-content-between align-items-center">
            Kategori Agenda
            <!-- Tombol Tambah Data -->
            <a href="{{ route('kategori-agenda.create') }}" class="btn btn-primary">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Tombol Edit -->
                            <a href="{{ route('kategori-agenda.edit', $kategori->id) }}" class="btn btn-sm btn-warning">
                                <i class="bx bx-pencil"></i>
                            </a>

                            <!-- Tombol Hapus -->
                            <form action="{{ route('kategori-agenda.destroy', $kategori->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                    ...
                    <!-- Modal untuk Show -->
                    <div class="modal fade" id="showModal{{ $kategori->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
